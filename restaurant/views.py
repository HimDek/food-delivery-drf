...
from .permissions import IsInProfileMenuOrReadOnly
...
class ListRestaurants(generics.ListAPIView):
    ...
    def get_queryset(self):
        return Profile.objects_within_square(
...
class RetrieveUpdateProduct(generics.RetrieveUpdateAPIView):
    ...
    def patch(self, request, pk):
        ...
        if request.POST.get("nonveg"):
            product.nonveg = True if request.POST.get("nonveg") == "true" else False
            ...
            return Response(
                {
                    ...
                    "info": "delivery charge calculated based on distance",
                }
            )
