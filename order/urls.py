...
from .views import (
    ...
    CancelOrder,
    AcceptOrder,
    OrderCookingFinished,
    OrderPickedUp,
    OrderArrived,
    OrderDelivered,
    OrderPaidToRestaurant,
    OrderPaidToRestaurantConfirm,
    ListAvailableDeliveryMan,
)
...
urlpatterns = [
    ...
    path(
        "paidtorestaurantconfirm/",
        OrderPaidToRestaurantConfirm.as_view(),
        name="paidToRestaurantConfirm",
    ),
    path(
        "availableDeliveryMan/",
        ListAvailableDeliveryMan.as_view(),
        name="listAvailableDeliveryMan",
    ),
]
